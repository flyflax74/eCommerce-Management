...
public class ShippingRateController {
    ...
    private final String defaultRedirectUrl = "redirect:/shipping_rates/offset/10/page/1?sortField=country&sortDir=asc";
    ...
    public String updateCodSupported(@PathVariable("id") Integer id, @PathVariable("supported") Boolean supported,
                                     @NotNull RedirectAttributes attributes, HttpServletRequest request) {
        try {
    ...
    public String deleteShippingRate(@PathVariable("id") Integer id, @NotNull RedirectAttributes attributes, HttpServletRequest request) {
        try {
            service.delete(id);
