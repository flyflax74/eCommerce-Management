...
public class OrderDetail implements Serializable {
    ...
    public OrderDetail(Category category, int quantity, float productCost, float shippingCost, float subtotal) {
    ...
    public OrderDetail(Brand brand, int quantity, float productCost, float shippingCost, float subtotal) {
        this.product = new Product();
