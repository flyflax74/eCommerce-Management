...
public class CategoryService {
    ...
    public List<Category> listAll() {
        return listByPage(new CategoryPageUtil(), 1, 1,"asc", null);
    }

    public List<Category> listByPage(CategoryPageUtil categoryPage, int pageNumber, int pageSize, String sortDir, String keyword) {
        ...
        categoryPage.setTotalElements(pageCategories.getTotalElements());
        categoryPage.setTotalPages(pageCategories.getTotalPages());
