...
public class ProductService {
    ...
    public void listByPage(int pageNumber, int pageSize, @NotNull PagingAndSortingHelper helper, Integer categoryId) {
        Pageable pageable = helper.createPageable(pageSize, pageNumber);
    ...
    public void searchProducts(int pageNum, int pageSize, @NotNull PagingAndSortingHelper helper) {
